...
void configt::set_object_bits_from_symbol_table(
  const symbol_tablet &symbol_table)
{
  // HACK: goto-instrument doesn't take object-bit argument
  // nor does it read from goto-program
  // It's probably a bug. Let's just hard code it here.
  bv_encoding.object_bits = 14;
  return;
