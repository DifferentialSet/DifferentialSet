  ...
  message_handlert &message_handler)
{
  ...
  ansi_c_language.typecheck(goto_model.symbol_table, "");
  ...
  for(auto &gf_entry : goto_model.goto_functions.function_map)
  {
    ...
    Forall_goto_program_instructions(i_it, gf_entry.second.body)
    {
      ...
      //   goto_programt::targett t1 = gf_entry.second.body.insert_after(
      //     i_it,
      //     goto_programt::make_function_call(
      //       function_to_call(goto_model.symbol_table, "branch_id", "taken")));

      //   goto_programt::targett t2 = gf_entry.second.body.insert_after(
      //     t1, goto_programt::make_goto(i_it->get_target(), true_exprt()));

      //   goto_programt::targett t3 = gf_entry.second.body.insert_after(
      //     t2,
      //     goto_programt::make_function_call(
  ...
  symbol_tablet &sym_table)
{
  ...
  case GOTO:
  {
    ins_it->set_condition(visit_to_get_transform_mem_ops(const_cast<exprt&>(ins_it->get_condition()), log, extra_code, sym_table));
    break;
  }
