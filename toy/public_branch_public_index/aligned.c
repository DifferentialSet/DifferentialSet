...
signed int main()
{
  ...
  if (!(main_p_pub == 0))
  {
    ...
    memop_var_0 = uint32_t_secure_load_single((unsigned int *) (&main_arr[main_index]), obsv_ds_$0_0, obsv_ds_bases_size_$0_0, obsv_ds_size_$0_0);
  ...
  memop_var_1 = uint32_t_secure_load_single((unsigned int *) (&main_arr[main_index]), obsv_ds_$1_0, obsv_ds_bases_size_$1_0, obsv_ds_size_$1_0);
