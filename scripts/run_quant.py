...
# Blazer benchmarks
benchmark_paths += [("/app/benchmarks/quantification/blazer_array_safe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_array_unsafe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_loopandbranch_safe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_loopandbranch_unsafe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_sanity_safe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_sanity_unsafe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_straightline_safe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_straightline_unsafe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_unixlogin_safe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_unixlogin_unsafe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_modpow1_safe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_modpow1_unsafe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_modpow2_safe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_modpow2_unsafe/", 32)] # compositional
benchmark_paths += [("/app/benchmarks/quantification/blazer_passwordEq_safe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_passwordEq_unsafe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_k96_safe/", 32)] # compositional
benchmark_paths += [("/app/benchmarks/quantification/blazer_k96_unsafe/", 32)] # compositional
benchmark_paths += [("/app/benchmarks/quantification/blazer_gpt14_safe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_gpt14_unsafe/", 32)] # compositional
benchmark_paths += [("/app/benchmarks/quantification/blazer_login_safe/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/blazer_login_unsafe/", 1)]

# RSA benchmarks
benchmark_paths += [("/app/benchmarks/quantification/RSA/square_and_multiply/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/RSA/square_and_always_multiply/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/RSA/windowed_modular_exp_libgcrypt_161/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/RSA/windowed_modular_exp_libgcrypt_163/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/RSA/scatter_gather_openssl_1.0.2f/", 1)]
benchmark_paths += [("/app/benchmarks/quantification/RSA/defensive_gather/", 1)]
