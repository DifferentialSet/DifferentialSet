...
# benchmark_paths += ["toy/secret_and_public_index/"]
...
# benchmark_paths += ["quantification/blazer_modpow2_unsafe/"] # compositional
# benchmark_paths += ["quantification/blazer_passwordEq_safe/"]
# benchmark_paths += ["quantification/blazer_passwordEq_unsafe/"]
# benchmark_paths += ["quantification/blazer_k96_safe/"] # compositional
# benchmark_paths += ["quantification/blazer_k96_unsafe/"] # compositional
# benchmark_paths += ["quantification/blazer_gpt14_safe/"]
# benchmark_paths += ["quantification/blazer_gpt14_unsafe/"] # compositional
...
for benchmark_path in benchmark_paths:
    ...
    if do_quantification:
        ...
        with time_context(metrics_collector, "Counting CC"):
            ...
            # c = count(benchmark_path, my_env, count_data=True, count_combined=False)
            print(c)
