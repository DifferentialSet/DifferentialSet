...
signed int main()
{
  ...
  cast5_setkey_c->rr = cast5_setkey_key_len <= 10u ? 1 : 0;
  cast5_setkey_x[0] = cast5_setkey_p_key[0];
  cast5_setkey_x[1] = cast5_setkey_p_key[1];
  cast5_setkey_x[2] = cast5_setkey_p_key[2];
  cast5_setkey_x[3] = cast5_setkey_p_key[3];
  /* begin function key_schedule */
  ;
  key_schedule_x = cast5_setkey_x;
  key_schedule_z = cast5_setkey_z;
  key_schedule_k = cast5_setkey_k;
  key_schedule_z[0] = key_schedule_x[0] ^ s5[(signed int)(key_schedule_x[13 / 4] >> 8 * (3 - 13 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[15 / 4] >> 8 * (3 - 15 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[12 / 4] >> 8 * (3 - 12 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[14 / 4] >> 8 * (3 - 14 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[8 / 4] >> 8 * (3 - 8 % 4) & 255u)];
  key_schedule_z[1] = key_schedule_x[2] ^ s5[(signed int)(key_schedule_z[0 / 4] >> 8 * (3 - 0 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[2 / 4] >> 8 * (3 - 2 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[1 / 4] >> 8 * (3 - 1 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[3 / 4] >> 8 * (3 - 3 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[10 / 4] >> 8 * (3 - 10 % 4) & 255u)];
  key_schedule_z[2] = key_schedule_x[3] ^ s5[(signed int)(key_schedule_z[7 / 4] >> 8 * (3 - 7 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[6 / 4] >> 8 * (3 - 6 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[5 / 4] >> 8 * (3 - 5 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[4 / 4] >> 8 * (3 - 4 % 4) & 255u)] ^ s5[(signed int)(key_schedule_x[9 / 4] >> 8 * (3 - 9 % 4) & 255u)];
  key_schedule_z[3] = key_schedule_x[1] ^ s5[(signed int)(key_schedule_z[10 / 4] >> 8 * (3 - 10 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[9 / 4] >> 8 * (3 - 9 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[11 / 4] >> 8 * (3 - 11 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[8 / 4] >> 8 * (3 - 8 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[11 / 4] >> 8 * (3 - 11 % 4) & 255u)];
  key_schedule_k[0] = s5[(signed int)(key_schedule_z[8 / 4] >> 8 * (3 - 8 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[9 / 4] >> 8 * (3 - 9 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[7 / 4] >> 8 * (3 - 7 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[6 / 4] >> 8 * (3 - 6 % 4) & 255u)] ^ s5[(signed int)(key_schedule_z[2 / 4] >> 8 * (3 - 2 % 4) & 255u)];
  key_schedule_k[1] = s5[(signed int)(key_schedule_z[10 / 4] >> 8 * (3 - 10 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[11 / 4] >> 8 * (3 - 11 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[5 / 4] >> 8 * (3 - 5 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[4 / 4] >> 8 * (3 - 4 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[6 / 4] >> 8 * (3 - 6 % 4) & 255u)];
  key_schedule_k[2] = s5[(signed int)(key_schedule_z[12 / 4] >> 8 * (3 - 12 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[13 / 4] >> 8 * (3 - 13 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[3 / 4] >> 8 * (3 - 3 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[2 / 4] >> 8 * (3 - 2 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[9 / 4] >> 8 * (3 - 9 % 4) & 255u)];
  key_schedule_k[3] = s5[(signed int)(key_schedule_z[14 / 4] >> 8 * (3 - 14 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[15 / 4] >> 8 * (3 - 15 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[1 / 4] >> 8 * (3 - 1 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[0 / 4] >> 8 * (3 - 0 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[12 / 4] >> 8 * (3 - 12 % 4) & 255u)];
  key_schedule_x[0] = key_schedule_z[2] ^ s5[(signed int)(key_schedule_z[5 / 4] >> 8 * (3 - 5 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[7 / 4] >> 8 * (3 - 7 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[4 / 4] >> 8 * (3 - 4 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[6 / 4] >> 8 * (3 - 6 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[0 / 4] >> 8 * (3 - 0 % 4) & 255u)];
  key_schedule_x[1] = key_schedule_z[0] ^ s5[(signed int)(key_schedule_x[0 / 4] >> 8 * (3 - 0 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[2 / 4] >> 8 * (3 - 2 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[1 / 4] >> 8 * (3 - 1 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[3 / 4] >> 8 * (3 - 3 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[2 / 4] >> 8 * (3 - 2 % 4) & 255u)];
  key_schedule_x[2] = key_schedule_z[1] ^ s5[(signed int)(key_schedule_x[7 / 4] >> 8 * (3 - 7 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[6 / 4] >> 8 * (3 - 6 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[5 / 4] >> 8 * (3 - 5 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[4 / 4] >> 8 * (3 - 4 % 4) & 255u)] ^ s5[(signed int)(key_schedule_z[1 / 4] >> 8 * (3 - 1 % 4) & 255u)];
  key_schedule_x[3] = key_schedule_z[3] ^ s5[(signed int)(key_schedule_x[10 / 4] >> 8 * (3 - 10 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[9 / 4] >> 8 * (3 - 9 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[11 / 4] >> 8 * (3 - 11 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[8 / 4] >> 8 * (3 - 8 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[3 / 4] >> 8 * (3 - 3 % 4) & 255u)];
  key_schedule_k[4] = s5[(signed int)(key_schedule_x[3 / 4] >> 8 * (3 - 3 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[2 / 4] >> 8 * (3 - 2 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[12 / 4] >> 8 * (3 - 12 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[13 / 4] >> 8 * (3 - 13 % 4) & 255u)] ^ s5[(signed int)(key_schedule_x[8 / 4] >> 8 * (3 - 8 % 4) & 255u)];
  key_schedule_k[5] = s5[(signed int)(key_schedule_x[1 / 4] >> 8 * (3 - 1 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[0 / 4] >> 8 * (3 - 0 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[14 / 4] >> 8 * (3 - 14 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[15 / 4] >> 8 * (3 - 15 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[13 / 4] >> 8 * (3 - 13 % 4) & 255u)];
  key_schedule_k[6] = s5[(signed int)(key_schedule_x[7 / 4] >> 8 * (3 - 7 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[6 / 4] >> 8 * (3 - 6 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[8 / 4] >> 8 * (3 - 8 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[9 / 4] >> 8 * (3 - 9 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[3 / 4] >> 8 * (3 - 3 % 4) & 255u)];
  key_schedule_k[7] = s5[(signed int)(key_schedule_x[5 / 4] >> 8 * (3 - 5 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[4 / 4] >> 8 * (3 - 4 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[10 / 4] >> 8 * (3 - 10 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[11 / 4] >> 8 * (3 - 11 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[7 / 4] >> 8 * (3 - 7 % 4) & 255u)];
  key_schedule_z[0] = key_schedule_x[0] ^ s5[(signed int)(key_schedule_x[13 / 4] >> 8 * (3 - 13 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[15 / 4] >> 8 * (3 - 15 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[12 / 4] >> 8 * (3 - 12 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[14 / 4] >> 8 * (3 - 14 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[8 / 4] >> 8 * (3 - 8 % 4) & 255u)];
  key_schedule_z[1] = key_schedule_x[2] ^ s5[(signed int)(key_schedule_z[0 / 4] >> 8 * (3 - 0 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[2 / 4] >> 8 * (3 - 2 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[1 / 4] >> 8 * (3 - 1 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[3 / 4] >> 8 * (3 - 3 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[10 / 4] >> 8 * (3 - 10 % 4) & 255u)];
  key_schedule_z[2] = key_schedule_x[3] ^ s5[(signed int)(key_schedule_z[7 / 4] >> 8 * (3 - 7 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[6 / 4] >> 8 * (3 - 6 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[5 / 4] >> 8 * (3 - 5 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[4 / 4] >> 8 * (3 - 4 % 4) & 255u)] ^ s5[(signed int)(key_schedule_x[9 / 4] >> 8 * (3 - 9 % 4) & 255u)];
  key_schedule_z[3] = key_schedule_x[1] ^ s5[(signed int)(key_schedule_z[10 / 4] >> 8 * (3 - 10 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[9 / 4] >> 8 * (3 - 9 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[11 / 4] >> 8 * (3 - 11 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[8 / 4] >> 8 * (3 - 8 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[11 / 4] >> 8 * (3 - 11 % 4) & 255u)];
  key_schedule_k[8] = s5[(signed int)(key_schedule_z[3 / 4] >> 8 * (3 - 3 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[2 / 4] >> 8 * (3 - 2 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[12 / 4] >> 8 * (3 - 12 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[13 / 4] >> 8 * (3 - 13 % 4) & 255u)] ^ s5[(signed int)(key_schedule_z[9 / 4] >> 8 * (3 - 9 % 4) & 255u)];
  key_schedule_k[9] = s5[(signed int)(key_schedule_z[1 / 4] >> 8 * (3 - 1 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[0 / 4] >> 8 * (3 - 0 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[14 / 4] >> 8 * (3 - 14 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[15 / 4] >> 8 * (3 - 15 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[12 / 4] >> 8 * (3 - 12 % 4) & 255u)];
  key_schedule_k[10] = s5[(signed int)(key_schedule_z[7 / 4] >> 8 * (3 - 7 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[6 / 4] >> 8 * (3 - 6 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[8 / 4] >> 8 * (3 - 8 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[9 / 4] >> 8 * (3 - 9 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[2 / 4] >> 8 * (3 - 2 % 4) & 255u)];
  key_schedule_k[11] = s5[(signed int)(key_schedule_z[5 / 4] >> 8 * (3 - 5 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[4 / 4] >> 8 * (3 - 4 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[10 / 4] >> 8 * (3 - 10 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[11 / 4] >> 8 * (3 - 11 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[6 / 4] >> 8 * (3 - 6 % 4) & 255u)];
  key_schedule_x[0] = key_schedule_z[2] ^ s5[(signed int)(key_schedule_z[5 / 4] >> 8 * (3 - 5 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[7 / 4] >> 8 * (3 - 7 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[4 / 4] >> 8 * (3 - 4 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[6 / 4] >> 8 * (3 - 6 % 4) & 255u)] ^ s7[(signed int)(key_schedule_z[0 / 4] >> 8 * (3 - 0 % 4) & 255u)];
  key_schedule_x[1] = key_schedule_z[0] ^ s5[(signed int)(key_schedule_x[0 / 4] >> 8 * (3 - 0 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[2 / 4] >> 8 * (3 - 2 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[1 / 4] >> 8 * (3 - 1 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[3 / 4] >> 8 * (3 - 3 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_z[2 / 4] >> 8 * (3 - 2 % 4) & 255u)];
  key_schedule_x[2] = key_schedule_z[1] ^ s5[(signed int)(key_schedule_x[7 / 4] >> 8 * (3 - 7 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[6 / 4] >> 8 * (3 - 6 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[5 / 4] >> 8 * (3 - 5 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[4 / 4] >> 8 * (3 - 4 % 4) & 255u)] ^ s5[(signed int)(key_schedule_z[1 / 4] >> 8 * (3 - 1 % 4) & 255u)];
  key_schedule_x[3] = key_schedule_z[3] ^ s5[(signed int)(key_schedule_x[10 / 4] >> 8 * (3 - 10 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[9 / 4] >> 8 * (3 - 9 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[11 / 4] >> 8 * (3 - 11 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[8 / 4] >> 8 * (3 - 8 % 4) & 255u)] ^ s6[(signed int)(key_schedule_z[3 / 4] >> 8 * (3 - 3 % 4) & 255u)];
  key_schedule_k[12] = s5[(signed int)(key_schedule_x[8 / 4] >> 8 * (3 - 8 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[9 / 4] >> 8 * (3 - 9 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[7 / 4] >> 8 * (3 - 7 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[6 / 4] >> 8 * (3 - 6 % 4) & 255u)] ^ s5[(signed int)(key_schedule_x[3 / 4] >> 8 * (3 - 3 % 4) & 255u)];
  key_schedule_k[13] = s5[(signed int)(key_schedule_x[10 / 4] >> 8 * (3 - 10 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[11 / 4] >> 8 * (3 - 11 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[5 / 4] >> 8 * (3 - 5 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[4 / 4] >> 8 * (3 - 4 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[7 / 4] >> 8 * (3 - 7 % 4) & 255u)];
  key_schedule_k[14] = s5[(signed int)(key_schedule_x[12 / 4] >> 8 * (3 - 12 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[13 / 4] >> 8 * (3 - 13 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[3 / 4] >> 8 * (3 - 3 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[2 / 4] >> 8 * (3 - 2 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[8 / 4] >> 8 * (3 - 8 % 4) & 255u)];
  key_schedule_k[15] = s5[(signed int)(key_schedule_x[14 / 4] >> 8 * (3 - 14 % 4) & 255u)] ^ s6[(signed int)(key_schedule_x[15 / 4] >> 8 * (3 - 15 % 4) & 255u)] ^ s7[(signed int)(key_schedule_x[1 / 4] >> 8 * (3 - 1 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[0 / 4] >> 8 * (3 - 0 % 4) & 255u)] ^ sb8[(signed int)(key_schedule_x[13 / 4] >> 8 * (3 - 13 % 4) & 255u)];
  /* end function key_schedule */
  ;
  cast5_setkey_i = 0;
  cast5_setkey_c->Km[cast5_setkey_i] = cast5_setkey_k[cast5_setkey_i];
  ...
  ;
  cast5_setkey_i = 0;
  cast5_setkey_c->Kr[cast5_setkey_i] = (uint8_t)(cast5_setkey_k[cast5_setkey_i] & 31u);
  cast5_setkey_i = cast5_setkey_i + 1;
  cast5_setkey_c->Kr[cast5_setkey_i] = (uint8_t)(cast5_setkey_k[cast5_setkey_i] & 31u);
  cast5_setkey_i = cast5_setkey_i + 1;
  cast5_setkey_c->Kr[cast5_setkey_i] = (uint8_t)(cast5_setkey_k[cast5_setkey_i] & 31u);
  ...
  cast5_setkey_i = cast5_setkey_i + 1;
  0;
  /* end function cast5_setkey */
  ;
  /* begin function cast5_encrypt */
  ;
  cast5_encrypt_c = &main_ctx;
  cast5_encrypt_outbuf = out;
  cast5_encrypt_inbuf = in_pub;
  cast5_encrypt_rr = main_ctx.rr;
  ...
  cast5_encrypt_l = cast5_encrypt_src[0];
  cast5_encrypt_r = cast5_encrypt_src[1];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[0] + cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[0] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[0];
  cast5_encrypt_r = cast5_encrypt_t ^ ((s1[(signed int)(cast5_encrypt_I >> 24)] ^ s2[(signed int)(cast5_encrypt_I >> 16 & 255u)]) - s3[(signed int)(cast5_encrypt_I >> 8 & 255u)]) + s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[1] ^ cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[1] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[1];
  cast5_encrypt_r = cast5_encrypt_t ^ (s1[(signed int)(cast5_encrypt_I >> 24)] - s2[(signed int)(cast5_encrypt_I >> 16 & 255u)]) + s3[(signed int)(cast5_encrypt_I >> 8 & 255u)] ^ s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[2] - cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[2] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[2];
  cast5_encrypt_r = cast5_encrypt_t ^ (s1[(signed int)(cast5_encrypt_I >> 24)] + s2[(signed int)(cast5_encrypt_I >> 16 & 255u)] ^ s3[(signed int)(cast5_encrypt_I >> 8 & 255u)]) - s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[3] + cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[3] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[3];
  cast5_encrypt_r = cast5_encrypt_t ^ ((s1[(signed int)(cast5_encrypt_I >> 24)] ^ s2[(signed int)(cast5_encrypt_I >> 16 & 255u)]) - s3[(signed int)(cast5_encrypt_I >> 8 & 255u)]) + s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[4] ^ cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[4] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[4];
  cast5_encrypt_r = cast5_encrypt_t ^ (s1[(signed int)(cast5_encrypt_I >> 24)] - s2[(signed int)(cast5_encrypt_I >> 16 & 255u)]) + s3[(signed int)(cast5_encrypt_I >> 8 & 255u)] ^ s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[5] - cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[5] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[5];
  cast5_encrypt_r = cast5_encrypt_t ^ (s1[(signed int)(cast5_encrypt_I >> 24)] + s2[(signed int)(cast5_encrypt_I >> 16 & 255u)] ^ s3[(signed int)(cast5_encrypt_I >> 8 & 255u)]) - s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[6] + cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[6] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[6];
  cast5_encrypt_r = cast5_encrypt_t ^ ((s1[(signed int)(cast5_encrypt_I >> 24)] ^ s2[(signed int)(cast5_encrypt_I >> 16 & 255u)]) - s3[(signed int)(cast5_encrypt_I >> 8 & 255u)]) + s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[7] ^ cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[7] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[7];
  cast5_encrypt_r = cast5_encrypt_t ^ (s1[(signed int)(cast5_encrypt_I >> 24)] - s2[(signed int)(cast5_encrypt_I >> 16 & 255u)]) + s3[(signed int)(cast5_encrypt_I >> 8 & 255u)] ^ s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[8] - cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[8] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[8];
  cast5_encrypt_r = cast5_encrypt_t ^ (s1[(signed int)(cast5_encrypt_I >> 24)] + s2[(signed int)(cast5_encrypt_I >> 16 & 255u)] ^ s3[(signed int)(cast5_encrypt_I >> 8 & 255u)]) - s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[9] + cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[9] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[9];
  cast5_encrypt_r = cast5_encrypt_t ^ ((s1[(signed int)(cast5_encrypt_I >> 24)] ^ s2[(signed int)(cast5_encrypt_I >> 16 & 255u)]) - s3[(signed int)(cast5_encrypt_I >> 8 & 255u)]) + s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[10] ^ cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[10] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[10];
  cast5_encrypt_r = cast5_encrypt_t ^ (s1[(signed int)(cast5_encrypt_I >> 24)] - s2[(signed int)(cast5_encrypt_I >> 16 & 255u)]) + s3[(signed int)(cast5_encrypt_I >> 8 & 255u)] ^ s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[11] - cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[11] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[11];
  cast5_encrypt_r = cast5_encrypt_t ^ (s1[(signed int)(cast5_encrypt_I >> 24)] + s2[(signed int)(cast5_encrypt_I >> 16 & 255u)] ^ s3[(signed int)(cast5_encrypt_I >> 8 & 255u)]) - s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[12] + cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[12] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[12];
  cast5_encrypt_r = cast5_encrypt_t ^ ((s1[(signed int)(cast5_encrypt_I >> 24)] ^ s2[(signed int)(cast5_encrypt_I >> 16 & 255u)]) - s3[(signed int)(cast5_encrypt_I >> 8 & 255u)]) + s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[13] ^ cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[13] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[13];
  cast5_encrypt_r = cast5_encrypt_t ^ (s1[(signed int)(cast5_encrypt_I >> 24)] - s2[(signed int)(cast5_encrypt_I >> 16 & 255u)]) + s3[(signed int)(cast5_encrypt_I >> 8 & 255u)] ^ s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[14] - cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[14] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[14];
  cast5_encrypt_r = cast5_encrypt_t ^ (s1[(signed int)(cast5_encrypt_I >> 24)] + s2[(signed int)(cast5_encrypt_I >> 16 & 255u)] ^ s3[(signed int)(cast5_encrypt_I >> 8 & 255u)]) - s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_t = cast5_encrypt_l;
  cast5_encrypt_l = cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_Km[15] + cast5_encrypt_r;
  cast5_encrypt_I = cast5_encrypt_I << (signed int)cast5_encrypt_Kr[15] | cast5_encrypt_I >> 32 - (signed int)cast5_encrypt_Kr[15];
  cast5_encrypt_r = cast5_encrypt_t ^ ((s1[(signed int)(cast5_encrypt_I >> 24)] ^ s2[(signed int)(cast5_encrypt_I >> 16 & 255u)]) - s3[(signed int)(cast5_encrypt_I >> 8 & 255u)]) + s4[(signed int)(cast5_encrypt_I & 255u)];
  cast5_encrypt_dst[0] = cast5_encrypt_r;
  cast5_encrypt_dst[1] = cast5_encrypt_l;
  /* end function cast5_encrypt */
  ;
