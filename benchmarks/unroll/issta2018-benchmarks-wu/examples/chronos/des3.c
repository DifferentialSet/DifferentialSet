...
// des3_ede_setkey__return_value
// 
static signed int des3_ede_setkey__return_value;
...
signed int main(int argc, char** argv)
{
  ...
  dkey_pt = pc2;
  dkey_d = (unsigned long int)dkey_k[4];
  dkey_d = dkey_d & 14ul;
  dkey_d = dkey_d << 4;
  dkey_d = dkey_d | (unsigned long int)((signed int)dkey_k[0] & 0x1E);
  dkey_d = (unsigned long int)pc1[(signed int)dkey_d];
  dkey_c = (unsigned long int)dkey_k[5];
  dkey_c = dkey_c & 14ul;
  dkey_c = dkey_c << 4;
  dkey_c = dkey_c | (unsigned long int)((signed int)dkey_k[1] & 0x1E);
  dkey_c = (unsigned long int)pc1[(signed int)dkey_c];
  dkey_b = (unsigned long int)dkey_k[6];
  dkey_b = dkey_b & 14ul;
  dkey_b = dkey_b << 4;
  dkey_b = dkey_b | (unsigned long int)((signed int)dkey_k[2] & 0x1E);
  dkey_b = (unsigned long int)pc1[(signed int)dkey_b];
  dkey_a = (unsigned long int)dkey_k[7];
  dkey_a = dkey_a & 14ul;
  dkey_a = dkey_a << 4;
  dkey_a = dkey_a | (unsigned long int)((signed int)dkey_k[3] & 0x1E);
  dkey_a = (unsigned long int)pc1[(signed int)dkey_a];
  dkey_pe[0 * 2] = dkey_pt[(signed int)(2ul * dkey_d + 3ul)] | dkey_pt[(signed int)(2ul * dkey_c + 2ul)] | dkey_pt[(signed int)(2ul * dkey_b + 1ul)] | dkey_pt[(signed int)(2ul * dkey_a + 0ul)];
  dkey_d = (unsigned long int)rs[(signed int)dkey_d];
  dkey_pe[1 * 2] = dkey_pt[(signed int)(2ul * dkey_c + 3ul)] | dkey_pt[(signed int)(2ul * dkey_b + 2ul)] | dkey_pt[(signed int)(2ul * dkey_a + 1ul)] | dkey_pt[(signed int)(2ul * dkey_d + 0ul)];
  dkey_c = (unsigned long int)rs[(signed int)dkey_c];
  dkey_b = (unsigned long int)rs[(signed int)dkey_b];
  dkey_pe[2 * 2] = dkey_pt[(signed int)(2ul * dkey_a + 3ul)] | dkey_pt[(signed int)(2ul * dkey_d + 2ul)] | dkey_pt[(signed int)(2ul * dkey_c + 1ul)] | dkey_pt[(signed int)(2ul * dkey_b + 0ul)];
  dkey_a = (unsigned long int)rs[(signed int)dkey_a];
  dkey_d = (unsigned long int)rs[(signed int)dkey_d];
  dkey_pe[3 * 2] = dkey_pt[(signed int)(2ul * dkey_c + 3ul)] | dkey_pt[(signed int)(2ul * dkey_b + 2ul)] | dkey_pt[(signed int)(2ul * dkey_a + 1ul)] | dkey_pt[(signed int)(2ul * dkey_d + 0ul)];
  dkey_c = (unsigned long int)rs[(signed int)dkey_c];
  dkey_b = (unsigned long int)rs[(signed int)dkey_b];
  dkey_pe[4 * 2] = dkey_pt[(signed int)(2ul * dkey_a + 3ul)] | dkey_pt[(signed int)(2ul * dkey_d + 2ul)] | dkey_pt[(signed int)(2ul * dkey_c + 1ul)] | dkey_pt[(signed int)(2ul * dkey_b + 0ul)];
  dkey_a = (unsigned long int)rs[(signed int)dkey_a];
  dkey_d = (unsigned long int)rs[(signed int)dkey_d];
  dkey_pe[5 * 2] = dkey_pt[(signed int)(2ul * dkey_c + 3ul)] | dkey_pt[(signed int)(2ul * dkey_b + 2ul)] | dkey_pt[(signed int)(2ul * dkey_a + 1ul)] | dkey_pt[(signed int)(2ul * dkey_d + 0ul)];
  dkey_c = (unsigned long int)rs[(signed int)dkey_c];
  dkey_b = (unsigned long int)rs[(signed int)dkey_b];
  dkey_pe[6 * 2] = dkey_pt[(signed int)(2ul * dkey_a + 3ul)] | dkey_pt[(signed int)(2ul * dkey_d + 2ul)] | dkey_pt[(signed int)(2ul * dkey_c + 1ul)] | dkey_pt[(signed int)(2ul * dkey_b + 0ul)];
  dkey_a = (unsigned long int)rs[(signed int)dkey_a];
  dkey_d = (unsigned long int)rs[(signed int)dkey_d];
  dkey_pe[7 * 2] = dkey_pt[(signed int)(2ul * dkey_c + 3ul)] | dkey_pt[(signed int)(2ul * dkey_b + 2ul)] | dkey_pt[(signed int)(2ul * dkey_a + 1ul)] | dkey_pt[(signed int)(2ul * dkey_d + 0ul)];
  dkey_c = (unsigned long int)rs[(signed int)dkey_c];
  dkey_pe[8 * 2] = dkey_pt[(signed int)(2ul * dkey_b + 3ul)] | dkey_pt[(signed int)(2ul * dkey_a + 2ul)] | dkey_pt[(signed int)(2ul * dkey_d + 1ul)] | dkey_pt[(signed int)(2ul * dkey_c + 0ul)];
  dkey_b = (unsigned long int)rs[(signed int)dkey_b];
  dkey_a = (unsigned long int)rs[(signed int)dkey_a];
  dkey_pe[9 * 2] = dkey_pt[(signed int)(2ul * dkey_d + 3ul)] | dkey_pt[(signed int)(2ul * dkey_c + 2ul)] | dkey_pt[(signed int)(2ul * dkey_b + 1ul)] | dkey_pt[(signed int)(2ul * dkey_a + 0ul)];
  dkey_d = (unsigned long int)rs[(signed int)dkey_d];
  dkey_c = (unsigned long int)rs[(signed int)dkey_c];
  dkey_pe[10 * 2] = dkey_pt[(signed int)(2ul * dkey_b + 3ul)] | dkey_pt[(signed int)(2ul * dkey_a + 2ul)] | dkey_pt[(signed int)(2ul * dkey_d + 1ul)] | dkey_pt[(signed int)(2ul * dkey_c + 0ul)];
  dkey_b = (unsigned long int)rs[(signed int)dkey_b];
  dkey_a = (unsigned long int)rs[(signed int)dkey_a];
  dkey_pe[11 * 2] = dkey_pt[(signed int)(2ul * dkey_d + 3ul)] | dkey_pt[(signed int)(2ul * dkey_c + 2ul)] | dkey_pt[(signed int)(2ul * dkey_b + 1ul)] | dkey_pt[(signed int)(2ul * dkey_a + 0ul)];
  dkey_d = (unsigned long int)rs[(signed int)dkey_d];
  dkey_c = (unsigned long int)rs[(signed int)dkey_c];
  dkey_pe[12 * 2] = dkey_pt[(signed int)(2ul * dkey_b + 3ul)] | dkey_pt[(signed int)(2ul * dkey_a + 2ul)] | dkey_pt[(signed int)(2ul * dkey_d + 1ul)] | dkey_pt[(signed int)(2ul * dkey_c + 0ul)];
  dkey_b = (unsigned long int)rs[(signed int)dkey_b];
  dkey_a = (unsigned long int)rs[(signed int)dkey_a];
  dkey_pe[13 * 2] = dkey_pt[(signed int)(2ul * dkey_d + 3ul)] | dkey_pt[(signed int)(2ul * dkey_c + 2ul)] | dkey_pt[(signed int)(2ul * dkey_b + 1ul)] | dkey_pt[(signed int)(2ul * dkey_a + 0ul)];
  dkey_d = (unsigned long int)rs[(signed int)dkey_d];
  dkey_c = (unsigned long int)rs[(signed int)dkey_c];
  dkey_pe[14 * 2] = dkey_pt[(signed int)(2ul * dkey_b + 3ul)] | dkey_pt[(signed int)(2ul * dkey_a + 2ul)] | dkey_pt[(signed int)(2ul * dkey_d + 1ul)] | dkey_pt[(signed int)(2ul * dkey_c + 0ul)];
  dkey_b = (unsigned long int)rs[(signed int)dkey_b];
  dkey_pe[15 * 2] = dkey_pt[(signed int)(2ul * dkey_a + 3ul)] | dkey_pt[(signed int)(2ul * dkey_d + 2ul)] | dkey_pt[(signed int)(2ul * dkey_c + 1ul)] | dkey_pt[(signed int)(2ul * dkey_b + 0ul)];
  dkey_d = (unsigned long int)dkey_k[0];
  dkey_d = dkey_d & 224ul;
  dkey_d = dkey_d >> 4;
  dkey_d = dkey_d | (unsigned long int)((signed int)dkey_k[4] & 0xF0);
  dkey_d = (unsigned long int)pc1[(signed int)(dkey_d + 1ul)];
  dkey_c = (unsigned long int)dkey_k[1];
  dkey_c = dkey_c & 224ul;
  dkey_c = dkey_c >> 4;
  dkey_c = dkey_c | (unsigned long int)((signed int)dkey_k[5] & 0xF0);
  dkey_c = (unsigned long int)pc1[(signed int)(dkey_c + 1ul)];
  dkey_b = (unsigned long int)dkey_k[2];
  dkey_b = dkey_b & 224ul;
  dkey_b = dkey_b >> 4;
  dkey_b = dkey_b | (unsigned long int)((signed int)dkey_k[6] & 0xF0);
  dkey_b = (unsigned long int)pc1[(signed int)(dkey_b + 1ul)];
  dkey_a = (unsigned long int)dkey_k[3];
  dkey_a = dkey_a & 224ul;
  dkey_a = dkey_a >> 4;
  dkey_a = dkey_a | (unsigned long int)((signed int)dkey_k[7] & 0xF0);
  dkey_a = (unsigned long int)pc1[(signed int)(dkey_a + 1ul)];
  dkey_pt = dkey_pt + 512;
  dkey_pe[0 * 2 + 1] = dkey_pt[(signed int)(2ul * dkey_a + 0ul)];
  dkey_d = 0ul;
  dkey_a = (unsigned long int)dkey_pe[(signed int)(2ul * dkey_d)];
  dkey_b = (unsigned long int)dkey_pe[(signed int)(2ul * dkey_d + 1ul)];
  dkey_c = dkey_a ^ dkey_b;
  dkey_c = dkey_c & 4294901760ul;
  dkey_a = dkey_a ^ dkey_c;
  dkey_b = dkey_b ^ dkey_c;
  dkey_b = dkey_b << 18 | dkey_b >> 32 - 18;
  dkey_pe[(signed int)(2ul * dkey_d)] = (uint32_t)dkey_a;
  dkey_pe[(signed int)(2ul * dkey_d + 1ul)] = (uint32_t)dkey_b;
  dkey_d = dkey_d + 1ul;
  dkey_a = (unsigned long int)dkey_pe[(signed int)(2ul * dkey_d)];
  dkey_b = (unsigned long int)dkey_pe[(signed int)(2ul * dkey_d + 1ul)];
  dkey_c = dkey_a ^ dkey_b;
  ...
  ;
  0;
  /* end function des3_ede_setkey */
  ;
  /* begin function des3_ede_encrypt */
  ;
  ...
  des3_ede_encrypt_L = des3_ede_encrypt_s[0];
  des3_ede_encrypt_R = des3_ede_encrypt_s[1];
  ...
  des3_ede_encrypt_B = des3_ede_encrypt_K[0];
  des3_ede_encrypt_A = des3_ede_encrypt_K[1];
  ...
  des3_ede_encrypt_L = des3_ede_encrypt_L ^ S8[(signed int)(255u & des3_ede_encrypt_B)];
  des3_ede_encrypt_A = des3_ede_encrypt_A & 1061109567u;
  des3_ede_encrypt_L = des3_ede_encrypt_L ^ S6[(signed int)(255u & des3_ede_encrypt_B >> 8)];
  des3_ede_encrypt_B = des3_ede_encrypt_B >> 16;
  des3_ede_encrypt_L = des3_ede_encrypt_L ^ S7[(signed int)(255u & des3_ede_encrypt_A)];
  des3_ede_encrypt_L = des3_ede_encrypt_L ^ S5[(signed int)(255u & des3_ede_encrypt_A >> 8)];
  des3_ede_encrypt_A = des3_ede_encrypt_A >> 16;
  des3_ede_encrypt_L = des3_ede_encrypt_L ^ S4[(signed int)(255u & des3_ede_encrypt_B)];
  des3_ede_encrypt_L = des3_ede_encrypt_L ^ S2[(signed int)(255u & des3_ede_encrypt_B >> 8)];
  des3_ede_encrypt_L = des3_ede_encrypt_L ^ S3[(signed int)(255u & des3_ede_encrypt_A)];
  des3_ede_encrypt_L = des3_ede_encrypt_L ^ S1[(signed int)(255u & des3_ede_encrypt_A >> 8)];
  des3_ede_encrypt_B = des3_ede_encrypt_K[0];
  des3_ede_encrypt_A = des3_ede_encrypt_K[1];
  des3_ede_encrypt_K = des3_ede_encrypt_K + 2;
  ...
  des3_ede_encrypt_B = des3_ede_encrypt_B & 1061109567u;
  des3_ede_encrypt_A = des3_ede_encrypt_A >> 4 | des3_ede_encrypt_A << 32 - 4;
  des3_ede_encrypt_R = des3_ede_encrypt_R ^ S8[(signed int)(255u & des3_ede_encrypt_B)];
  des3_ede_encrypt_A = des3_ede_encrypt_A & 1061109567u;
  des3_ede_encrypt_R = des3_ede_encrypt_R ^ S6[(signed int)(255u & des3_ede_encrypt_B >> 8)];
  des3_ede_encrypt_B = des3_ede_encrypt_B >> 16;
  des3_ede_encrypt_R = des3_ede_encrypt_R ^ S7[(signed int)(255u & des3_ede_encrypt_A)];
  des3_ede_encrypt_R = des3_ede_encrypt_R ^ S5[(signed int)(255u & des3_ede_encrypt_A >> 8)];
  des3_ede_encrypt_A = des3_ede_encrypt_A >> 16;
  des3_ede_encrypt_R = des3_ede_encrypt_R ^ S4[(signed int)(255u & des3_ede_encrypt_B)];
  des3_ede_encrypt_R = des3_ede_encrypt_R ^ S2[(signed int)(255u & des3_ede_encrypt_B >> 8)];
  des3_ede_encrypt_R = des3_ede_encrypt_R ^ S3[(signed int)(255u & des3_ede_encrypt_A)];
  des3_ede_encrypt_R = des3_ede_encrypt_R ^ S1[(signed int)(255u & des3_ede_encrypt_A >> 8)];
  ...
  des3_ede_encrypt_d[0] = des3_ede_encrypt_R;
  des3_ede_encrypt_d[1] = des3_ede_encrypt_L;
  /* end function des3_ede_encrypt */
  ;
  write(1, (const void *)&main_ctx, (size_t)sizeof(struct des3_ede_ctx) /*384ul*/ );
