...
int main()
{
    ...
    wc_ecc_import_raw_ex(&key2, Gx, Gy, Af, ECC_SECP256R1);
    wc_ecc_import_raw_ex(&key3, Gx, Gy, prime, ECC_SECP256R1);
...
#define INPUT_SIZE 32
    ...
    // wc_ecc_mulmod(&my_key, &G, &R, &a, &mod, 0);
   // wc_ecc_mulmod(&my_key, &G, &R, &a, &mod, 0);
