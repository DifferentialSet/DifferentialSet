...
benchmark_paths += ["issta2018-benchmarks-wu/examples/ghostrider/rsort/"] # haven't finished
...
for benchmark_path in benchmark_paths:
    ...
    try:
        ...
        with time(metrics_collector, "Building goto"):
        ...
        with time(metrics_collector, "Analysis"):
        ...
        with time(metrics_collector, "Enumerate DS"):
        ...
        if not do_quantification:
            ...
            with time(metrics_collector, "Get transform only"):
            ...
            with time(metrics_collector, "Dump transform only"):
            ...
            with time(metrics_collector, "Transform"):
            ...
            with time(metrics_collector, "Dump instrumented.c"):
            ...
            with time(metrics_collector, "Compile mitigated.c"):
            ...
            with time(metrics_collector, "Run mitigated"):
            ...
            with time(metrics_collector, "Run transform_only"):
        ...
        if do_quantification:
            ...
            with time(metrics_collector, "Generate DIMACS"):
            ...
            with time(metrics_collector, "Counting CC"):
